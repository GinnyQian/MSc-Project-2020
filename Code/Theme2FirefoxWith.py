...
class Theme2FirefoxWith(object):
    def __init__(self):
    ...
    def run(self, n=0):
        ...
        if not os.path.exists('./pics-2FW'):
            os.mkdir('./pics-2FW') # set a folder for downloaded pictures
...
if __name__ == '__main__':
    theme2firefoxwith = Theme2FirefoxWith()
    theme2firefoxwith.run()
