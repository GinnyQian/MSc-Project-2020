...
class Theme3ChromeWith(object):
    ...
    def run(self, n=0):
        ...
        if not os.path.exists('./pics-3CW'):
            os.mkdir('./pics-3CW') # set a folder for downloaded pictures
...
if __name__ == '__main__':
    theme3chromewith = Theme3ChromeWith()
    theme3chromewith.run()
