...
class Theme3EdgeWithout(object):
    def __init__(self):
    ...
    def run(self, n=0):
        ...
        if not os.path.exists('./pics-3PW'):
            os.mkdir('./pics-3PW') # set a folder for downloaded pictures
...
if __name__ == '__main__':
    theme3edgewithout = Theme3EdgeWithout()
    theme3edgewithout.run()
