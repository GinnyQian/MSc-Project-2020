...
class Theme3ChromeWithout(object):
    def __init__(self):
    ...
    def run(self, n=0):
        ...
        if not os.path.exists('./pics-3CWT'):
            os.mkdir('./pics-3CWT') # set a folder for downloaded pictures
...
if __name__ == '__main__':
    theme3chromewithout = Theme3ChromeWithout()
    theme3chromewithout.run()
