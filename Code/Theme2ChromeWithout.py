...
class Theme2ChromeWithout(object):
    def __init__(self):
    ...
    def run(self, n=0):
        ...
        if not os.path.exists('./pics-2CWT'):
            os.mkdir('./pics-2CWT') # set a folder for downloaded pictures
...
if __name__ == '__main__':
    theme2chromewithout = Theme2ChromeWithout()
    theme2chromewithout.run()
