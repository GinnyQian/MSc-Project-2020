...
class Theme3PhantomJSWith(object):
    def __init__(self):
    ...
    def run(self, n=0):
        ...
        if not os.path.exists('./pics-3PWT'):
            os.mkdir('./pics-3PWT') # set a folder for downloaded pictures
