...
class Theme1FirefoxWithout(object):
    def __init__(self):
    ...
    def run(self, n=0):
        ...
        if not os.path.exists('./pics-1FWT'):
            os.mkdir('./pics-1FWT') # set a folder for downloaded pictures
...
if __name__ == '__main__':
    theme1firefoxwithout = Theme1FirefoxWithout()
    theme1firefoxwithout.run()
