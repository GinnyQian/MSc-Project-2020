...
class Theme1EdgeWithout(object):
    def __init__(self):
    ...
    def run(self, n=0):
        ...
        if not os.path.exists('./pics-1PWT'):
            os.mkdir('./pics-1PWT') # set a folder for downloaded pictures
...
if __name__ == '__main__':
    theme1edgewithout = Theme1EdgeWithout()
    theme1edgewithout.run()