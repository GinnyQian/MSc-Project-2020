...
class Theme3FirefoxWithout(object):
    def __init__(self):
    ...
    def run(self, n=0):
        ...
        if not os.path.exists('./pics-3FWT'):
            os.mkdir('./pics-3FWT') # set a folder for downloaded pictures
...
if __name__ == '__main__':
    theme3firefoxwithout = Theme3FirefoxWithout()
    theme3firefoxwithout.run()
